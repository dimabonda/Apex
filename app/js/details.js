window.addEventListener("DOMContentLoaded", () => {
    ...
    const wrapper = document.querySelector(".cards-info-mobile");
    ...
    const closeInfoMobile = () => {
        const info = document.querySelector(".card-info-mobile_active")
        info.classList.remove('card-info-mobile_active')
    }

    const showInfoMobile = (card) => {
        const info = findMatchedInfoCardMobile(card);
        info.classList.add('card-info-mobile_active');
    }
